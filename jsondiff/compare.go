...
// to the former as a list of JSON Diff operations.
func Compare(source, target interface{}) (Diff, error) {
	var d Differ
...
func CompareOpts(source, target interface{}, opts ...Option) (Diff, error) {
	var d Differ
	d.applyOpts(opts...)
...
// a list of JSON Diff operations.
func CompareJSON(source, target []byte) (Diff, error) {
	var d Differ
...
func CompareJSONOpts(source, target []byte, opts ...Option) (Diff, error) {
	var d Differ
	d.applyOpts(opts...)
...
func compare(d *Differ, src, tgt interface{}) (Diff, error) {
...
func compareJSON(d *Differ, src, tgt []byte) (Diff, error) {
	var si, ti interface{}
